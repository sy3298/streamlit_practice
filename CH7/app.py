...
def main():
    ...
    st.sidebar.image("CH7/nlp.jpg", use_column_width=True)
    #製作菜單（下拉式清單）包含四個功能
    ...
    if choice == "Translation":
        ...
        if len(raw_text) < 3:
            ...
            target_lang = st.selectbox("Target Language",["German", "Spanish", "French", "Italian","Chinese"])
            ...
            if st.button("Translate"):
                translator = GoogleTranslator(source='auto', target=target_lang)  # set source and targetlanguages
